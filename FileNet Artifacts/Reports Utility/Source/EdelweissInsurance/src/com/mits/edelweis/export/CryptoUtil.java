...
public class CryptoUtil 
{
	 ...
	 Logger log=Logger.getLogger(CryptoUtil.class);
	...
	public static void main(String[] args) {
		...
		log.info("Encript::"+encryptPhrase("dms@12345"));
		log.info("mits123$::"+encryptPhrase("Mitsind$321"));
		System.out.println("en"+encryptPhrase("Mitsind$321"));
		} catch (Exception e) {
