...
public  class SessionClass {
	...
	public static VWSession get_Session()
	{
		...
		try
		{
			...
			String encPassword=properties.getProperty("FN_PASSWORD");
			...
			session.logon(properties.getProperty("FN_USER_NAME"),decPassword,properties.getProperty("FN_CONNECTIONPOINT"));
