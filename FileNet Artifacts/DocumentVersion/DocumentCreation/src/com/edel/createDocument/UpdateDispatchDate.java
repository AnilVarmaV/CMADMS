...
public class UpdateDispatchDate {
	
	public void UpdateDispatchedDate(Date dispatchDate, VWAttachment attach){
		try{

			System.out.println("UpdateDispatchedDate on Document Start:::::::::::::::::");

			System.out.println("Date at archival step1:::::::::::"+dispatchDate);
			...
			properties.putValue(config.getProperty(ASPConstants.DISPATCHDATE), dispatchDate);
